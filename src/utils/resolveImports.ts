...
export const resolveImportsForReferenceType = (
    ...
    if (
        ...
        resolveImports(referencedTypeDefinition.alias.alias, baseType, knownConjureTypes, typeGenerationFlags);
    }
...
const relativePath = (fromType: ITypeName, toType: ITypeName): string => {
...
export function directoryNameForType(typeName: ITypeName) {
