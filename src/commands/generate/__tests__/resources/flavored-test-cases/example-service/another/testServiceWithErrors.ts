...
export interface ITestServiceWithErrors {
    ...
    getAliasedString(datasetRid: string): Promise<IConjureResult<IAliasedString, never>>;
...
export class TestServiceWithErrors implements ITestServiceWithErrors {
    ...
    public getAliasedString(datasetRid: string): Promise<IConjureResult<IAliasedString, never>> {
        return this.bridge
            .call<IAliasedString>(
                "TestService",
                "getAliasedString",
            ...
            .then(result => ({ status: "success", result }) as IConjureSuccess<IAliasedString>)
            .catch(error => ({ status: "failure", error }) as IConjureFailure<never>);
    }
