...
export interface ITestServiceWithErrors {
     ...
     *
     */
    getFileSystems(): Promise<IConjureResult<{ readonly [key: string]: IBackingFileSystem }, never>>;
    ...
    getBranches(datasetRid: string): Promise<IConjureResult<ReadonlyArray<string>, never>>;
    /**
     * Gets all branches of this dataset.
     *
     * @deprecated use getBranches instead
     */
    getBranchesDeprecated(datasetRid: string): Promise<IConjureResult<ReadonlyArray<string>, never>>;
...
export class TestServiceWithErrors implements ITestServiceWithErrors {
     ...
     *
     */
    public getFileSystems(): Promise<IConjureResult<{ readonly [key: string]: IBackingFileSystem }, never>> {
        return this.bridge
            .call<{ readonly [key: string]: IBackingFileSystem }>(
                "TestService",
                "getFileSystems",
                "GET",
                "/catalog/fileSystems",
            ...
            .then(result => ({ status: "success", result }) as IConjureSuccess<{ readonly [key: string]: IBackingFileSystem }>)
    ...
    public getBranches(datasetRid: string): Promise<IConjureResult<ReadonlyArray<string>, never>> {
        return this.bridge
            ...
            .then(result => ({ status: "success", result }) as IConjureSuccess<ReadonlyArray<string>>)
            .catch(error => ({ status: "failure", error }) as IConjureFailure<never>);
    }
     ...
     * @deprecated use getBranches instead
     */
    public getBranchesDeprecated(datasetRid: string): Promise<IConjureResult<ReadonlyArray<string>, never>> {
        return this.bridge
            .call<ReadonlyArray<string>>(
                "TestService",
